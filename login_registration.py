...
# time .sleep(3)
# register = driver.find_element_by_css_selector(" p.woocomerce-FormRow.form-row > input.woocommerce-Button.button")
# register.click()
...
# enter.click()
# time . sleep(3)
# element = driver.find_element_by_css_selector(" li.woocommerce-MyAccount-navigation-link.woocommerce-MyAccount-navigation-link--customer-logout > a")
